...
export class ExperienceComponent implements OnInit {
  projects: Project[] = [
    ...
    },
    {
      ...
      technologies: [
        { id: 'icon-angular-variant', path: 'angular-variant.svg', title: 'Angular' },
      ],
      link: 'https://www.childrensworldcdc.com/',
      background: 'cdc.gif',
      ovarlay: 'laptop-black.svg'
    },
    {
      ...
      github: 'https://github.com/Judecx14/flutter-peliculas-app',
      background: 'peliculas-app.gif',
      ovarlay: 'phone-white.svg'
    },
    {
      ...
      technologies: [
        ...
        { id: 'icon-cloudinary', path: 'cloudinary.svg', title: 'Cloudinary' },
      ],
      github: 'https://github.com/Judecx14/flutter-productos-app',
      background: 'productos-app.gif',
      ovarlay: 'phone-white.svg'
    },
    {
      ...
      github: 'https://github.com/Judecx14/flutter-qr-reader',
      background: 'lector-qr-app.gif',
      ovarlay: 'phone-black.svg'
    },
    {
      id: 'news-app-modal',
      isWeb: false,
      ...
      github: 'https://github.com/Judecx14/flutter-noticias-app',
      background: 'news-app.gif',
      ovarlay: 'phone-white.svg'
    },
  ];
